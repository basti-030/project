...
// Route::get("editData", "DatabaseCheck@editData");
...
Route::get("/edit/worker_ID/{worker_ID}", "DatabaseCheck@editData");
Route::match(['get','post'], "/edit", "DatabaseCheck@editData");
Route::get("/new/worker_ID/{worker_ID}", "DatabaseCheck@editData");
